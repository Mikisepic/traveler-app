...
class GeoapifyService {
  ...
  Future<List<DiscoveryPlace>> fetchPlaceSuggestions(
      double lat, double lng, List<String> categories) async {
    final url = Uri.parse(
        "$placesURI?bias=proximity:$lng,$lat&categories=${categories.join(',')}&limit=20&apiKey=$geoapifyApiKey");
